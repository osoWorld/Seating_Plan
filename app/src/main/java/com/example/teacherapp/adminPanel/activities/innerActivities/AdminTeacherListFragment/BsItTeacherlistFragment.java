...
import com.example.teacherapp.databinding.FragmentBsItTeacherlistBinding;
...
public class BsItTeacherlistFragment extends Fragment {

    private FragmentBsItTeacherlistBinding binding;
    private ArrayList<TeacherStudentListModelClass> list;
    private DatabaseReference reference;
    private TeacherStudentListAdapter adapter;

    public BsItTeacherlistFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBsItTeacherlistBinding.inflate(inflater,container,false);
        list = new ArrayList<>();
