...
import com.example.teacherapp.databinding.FragmentViewAttendance123presentBinding;
...
public class ViewAttendance123presentFragment extends Fragment {

   private FragmentViewAttendance123presentBinding binding;
    private ArrayList<StudentAttendanceModelClass> list;
    private DatabaseReference reference;
    private StudentAttendanceAdapter adapter;

    public ViewAttendance123presentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = com.example.teacherapp.databinding.FragmentViewAttendance123presentBinding.inflate(inflater,container,false);
        getRoomData();
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    ...
                                    if (status.equals("Present")){
                                        ...
                                        Toast.makeText(requireContext(), "No one is present yet", Toast.LENGTH_SHORT).show();
