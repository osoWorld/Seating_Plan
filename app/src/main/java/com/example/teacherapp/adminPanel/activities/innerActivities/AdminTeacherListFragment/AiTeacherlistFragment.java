...
public class AiTeacherlistFragment extends Fragment {

   private FragmentAiTeacherlistBinding binding;
    private ArrayList<TeacherStudentListModelClass> list;
    private DatabaseReference reference;
    private TeacherStudentListAdapter adapter;

    public AiTeacherlistFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAiTeacherlistBinding.inflate(inflater,container,false);
        list = new ArrayList<>();
