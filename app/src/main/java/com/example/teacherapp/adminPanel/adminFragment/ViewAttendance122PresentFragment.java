...
import com.example.teacherapp.databinding.FragmentViewAttendance122PresentBinding;
...
public class ViewAttendance122PresentFragment extends Fragment {


    private FragmentViewAttendance122PresentBinding binding;
    private ArrayList<StudentAttendanceModelClass> list;
    private DatabaseReference reference;
    private StudentAttendanceAdapter adapter;

    public ViewAttendance122PresentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentViewAttendance122PresentBinding.inflate(inflater,container,false);
        getRoomData();
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    ...
                                    if (status.equals("Present")){
                                        ...
                                        binding.progressBB.setVisibility(View.GONE);
                                        Toast.makeText(requireContext(), "NO one is Present", Toast.LENGTH_SHORT).show();
                                    }
