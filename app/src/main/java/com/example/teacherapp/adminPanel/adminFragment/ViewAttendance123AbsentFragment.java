...
import com.example.teacherapp.databinding.FragmentViewAttendance123AbsentBinding;
...
public class ViewAttendance123AbsentFragment extends Fragment {

    private FragmentViewAttendance123AbsentBinding binding;
    private ArrayList<StudentAttendanceModelClass> list;
    private DatabaseReference reference;
    private StudentAttendanceAdapter adapter;
    public ViewAttendance123AbsentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = com.example.teacherapp.databinding.FragmentViewAttendance123AbsentBinding.inflate(inflater,container,false);
        getRoomData();
    ...
    private void getRoomData() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("AssignedRooms").child("123");
