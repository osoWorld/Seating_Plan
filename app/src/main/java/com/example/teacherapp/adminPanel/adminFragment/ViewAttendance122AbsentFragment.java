...
import com.example.teacherapp.databinding.FragmentViewAttendance122AbsentBinding;
...
public class ViewAttendance122AbsentFragment extends Fragment {
    private FragmentViewAttendance122AbsentBinding  binding;
    private ArrayList<StudentAttendanceModelClass> list;
    private DatabaseReference reference;
    private StudentAttendanceAdapter adapter;

    public ViewAttendance122AbsentFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentViewAttendance122AbsentBinding.inflate(inflater,container,false);
        getRoomData();
    ...
    private void getRoomData() {
        ...
        reference = FirebaseDatabase.getInstance().getReference("AssignedRooms").child("122");
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    ...
                                    if (status.equals("Absent")){
                                        ...
                                        Toast.makeText(requireContext(), "No one is absent", Toast.LENGTH_SHORT).show();
        ...
        binding.absentRecView.setAdapter(adapter);
        binding.absentRecView.setLayoutManager(new LinearLayoutManager(requireContext()));
    }
}