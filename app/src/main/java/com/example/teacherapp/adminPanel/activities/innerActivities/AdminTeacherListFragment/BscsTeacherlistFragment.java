...
public class BscsTeacherlistFragment extends Fragment {
    ...
    public BscsTeacherlistFragment() {
                ...
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        if (snapshot.exists()){
                            ...
                            binding.progressB.setVisibility(View.GONE);
                            Toast.makeText(requireActivity(), "no Teacher found", Toast.LENGTH_SHORT).show();
                        }
