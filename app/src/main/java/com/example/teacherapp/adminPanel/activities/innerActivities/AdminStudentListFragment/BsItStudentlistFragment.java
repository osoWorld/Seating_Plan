...
public class BsItStudentlistFragment extends Fragment {

    private FragmentBsItStudentlistBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentBsItStudentlistBinding.inflate(inflater,container,false);
        list = new ArrayList<>();
